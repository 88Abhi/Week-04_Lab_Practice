package regularexpressions.validatehexcolorcodetest;
...
import static com.regularexpressions.validatehexcolorcode.HexColorValidator.isValidHexColor;

// Class to test the hex color code
public class HexColorValidatorTest {
	// Method to test the hex code for colours
	@Test
