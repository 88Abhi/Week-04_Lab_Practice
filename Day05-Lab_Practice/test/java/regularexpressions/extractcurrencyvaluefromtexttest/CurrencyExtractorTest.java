package regularexpressions.extractcurrencyvaluefromtexttest;

import com.regularexpressions.extractcurrencyvaluesfromtext.CurrencyExtractor;
...
class CurrencyExtractorTest {
	// Method to test the currency value extractor
	@Test
