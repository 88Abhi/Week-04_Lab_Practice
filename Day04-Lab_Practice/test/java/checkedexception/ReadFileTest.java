...
import com.checkedexceptions.ReadFile;
...
class ReadFileTest {
	...
	public void testOfFileReadingMethod() {
		...
		String expectedData = ReadFile.readFile(path);

		if (expectedData.isBlank()) {
			assertThrows(IOException.class, () -> ReadFile.readFile(path2));
		}
