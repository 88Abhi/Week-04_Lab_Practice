...
public class CachingSystemExample {
	public static void main(String[] args) throws Exception {
		...
		if (method.isAnnotationPresent(CacheResult.class)) {
			...
			System.out.println("First Execution (No Cache): " + result1 + " | Time: " + (endTime1 - startTime1) / 100000 + " ms");

			// Measuring execution time with cache
			long startTime2 = System.nanoTime();
			long result2 = operation.factorial(10);
			long endTime2 = System.nanoTime();
			System.out.println("Second Execution (With Cache): " + result2 + " | Time: " + (endTime2 - startTime2) / 1000000 + " ms");
		}
	}
}
